...
promedio_alquiler_por_bano = inmuebles.groupby('Banos')['Valor'].mean().sort_index()
...
inmuebles['Banos'].hist(bins=range(inmuebles['Banos'].min(), inmuebles['Banos'].max() + 2), edgecolor='black')
